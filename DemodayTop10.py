...
bot.sendMessage(chat_id=-1001551112836, text='..')
bot.sendMessage(chat_id=-1001551112836, text='> Demoday Top 10 ('+str(datetime.date.today())+') >')
...
for each in li_list:
    ...
    bot.sendMessage(chat_id=-1001551112836, text=li_list[rank].text+'\n'+link)
    #bot.sendMessage(chat_id=5290341890, text=li_list[rank].text+'\n'+link)
    rank=rank+1


bot.sendMessage(chat_id=-1001551112836, text='======= End of Demoday =======')
