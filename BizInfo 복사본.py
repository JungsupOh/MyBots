...
def biz_info(driver, xls_filename, query):
    try:
        ...
        time.sleep(1)
        print('Debug #2-1')
        searchoption = driver.find_element_by_xpath("//button[@data-option='pldirJrsdCodeNm']").click()
        time.sleep(1)
        print('Debug #2-2')
        ...
        for keyword in query:
            ...
            bot.sendDocument(chat_id=167233193, document=open(root_path + 'Biz_Info.xlsx', 'rb'))
